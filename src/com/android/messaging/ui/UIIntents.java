...
public abstract class UIIntents {
   ...
   public static final int REQUEST_PICK_VCARD_PICKER = 1500;
   public static final int REQUEST_PICK_CONTACT_AS_TEXT = 1501;
   public static final int REQUEST_PICK_VIDEO_PICKER = 1600;
   public static final int REQUEST_PICK_AUDIO_PICKER = 1700;
   public static final int REQUEST_PICK_VCALENDAR_PICKER = 1800;
   public static final int REQUEST_PICK_ALARM_PICKER = 1900;
...
public static final String ACTION_TOAST_COPY_MESSAGE_TO_SIM =
    ...
    /**
     * Launch an activity to show the vcard picker.
     *
     * @param fragment the requesting fragment
     *
     */
    public abstract void launchVcardPicker(final Fragment fragment);
     /**
     * Launch an activity to show the Text picker.
     *
     * @param fragment the requesting fragment
     *
     */
    public abstract void launchTextPicker(final Fragment fragment);

    /**
     * Launch an activity to show the video picker.
     *
     * @param fragment the requesting fragment
     *
     */
    public abstract void launchVideoAttachPicker(final Fragment fragment);

    /**
     * Launch an activity to show the audio picker.
     *
     * @param fragment the requesting fragment
     *
     */
    public abstract void launchAudioAttachPicker(final Fragment fragment);

    /**
     * Launch an activity to show the calendar picker.
     *
     * @param fragment the requesting fragment
     */
    public abstract void launchVcalendarAttachPicker(final Fragment fragment);
    ...
    //public abstract void launchDrmPreviewActivity(Context context, MessagePartData message);

    public abstract void launchDrmRightRequestActivity(Context context, MessagePartData message);
    ...
    /**
     * Launch an activity to show details for a VCalendar
     */
    public abstract void launchVCalendarActivity(Context context, Uri vcardUri);
    /**
    ...
    public abstract void launchFullScreenVideoViewerForDrm(Context context, String drmPath);
    /**
    ...
    public abstract void launchFullScreenPhotoViewerForDrm(Activity activity, Uri initialPhoto,
            Rect initialPhotoBounds, Uri photosUri);
    ...
    /**
     * Launch an activity to play slideshow
     */
    public abstract void launchSlideshowActivity(Context context, Uri msgUri, int requestCode);
...
/**************************White Box testing**********************************/
  ...
  * Launch an activity to show a conversation.
  */
 public abstract void launchConversationTestActivity(final Context context,
                                                 final String conversationId, final MessageData draft, final Bundle activityOptions,
                                                 final boolean withCustomTransition, final Bundle bundle);
}
