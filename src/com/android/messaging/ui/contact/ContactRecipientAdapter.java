...
public final class ContactRecipientAdapter extends BaseRecipientAdapter {
    ...
    public class ContactFilter extends Filter {
        ...
        private Pair<Cursor, Boolean> getFilteredResultsCursor(final Context context,
            ...
            /*Add by SPRD for bug584098 20160810  Start*/
            ...
            /*Add by SPRD for bug584098 20160810  End*/
        ...
        protected FilterResults performFiltering(final CharSequence constraint) {
            ...
            // destination as a suggestion item to the drop down.
                    if (NumberMatchUtils.getNumberMatchUtils().getNumberMatchNotify().OnNotify(0,0,0,searchText,null)  == NumberMatchUtils.getNumberMatchUtils().SUCC/*PhoneUtils.isValidSmsMmsDestination(searchText)*/) {
                entries.add(ContactRecipientEntryUtils
                    ...
                    HashSet<Long> existingContactIds = new HashSet<Long>();
                        ...
                        boolean isFirstLevel = !existingContactIds.contains(contactId);
