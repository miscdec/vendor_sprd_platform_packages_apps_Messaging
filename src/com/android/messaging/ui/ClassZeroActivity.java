...
public class ClassZeroActivity extends Activity {
    ...
    protected void onCreate(final Bundle icicle) {
        ...
        MediaUtil.get().playSound(this, R.raw.audio_end, null);//Add for Bug 519929
    ...
    private void displayZeroMessage(final ContentValues messageValues) {
        ...
        mDialog = new AlertDialog.Builder(this).setMessage(message)
            ...
            //.setTitle(R.string.class_0_message_activity)  //bug882866 remove title
    ...
    protected void onNewIntent(final Intent msgIntent) {
        ...
        if (queueMsgFromIntent(msgIntent)) {
            MediaUtil.get().playSound(this, R.raw.audio_end, null);   //Bug 1150868
        }
    }
