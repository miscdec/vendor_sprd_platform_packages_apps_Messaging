...
public class PersonItemView extends LinearLayout implements PersonItemDataListener,
    ...
    private boolean mDisableContactIconClickAction;  //Bug 1180725
    ...
    //Bug 1180725 begin
    public void disableContactIconClickAction() {
        mDisableContactIconClickAction = true;
    }
    //Bug 1180725 end
    ...
    protected void updateViewAppearance() {
        if (mBinding.isBound()) {
            ...
            final BidiFormatter bidiFormatter = BidiFormatter.getInstance(); //by bug  1238916
            final String details = bidiFormatter.unicodeWrap(mBinding.getData().getDetails(), TextDirectionHeuristicsCompat.LTR); //by bug  1238916
            ...
            mContactIconView.animate().setDuration(0);
            ...
            //Bug 1180725 begin Warning: Can't Write as following code:
            // mContactIconView.setClickable(!mDisableContactIconClickAction);
            // mContactIconView.setLongClickable(!mDisableContactIconClickAction);
            if (mDisableContactIconClickAction) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        mContactIconView.updateaColorFilter(event);
