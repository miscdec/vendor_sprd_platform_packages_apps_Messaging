...
public class ShareIntentFragment extends DialogFragment implements ConversationListDataListener,
    ...
    public Dialog onCreateDialog(final Bundle bundle) {
        ...
        TextView share_ok = (TextView)view.findViewById(R.id.share_ok);
...
//            dialogBuilder.setPositiveButton(getString(R.string.share_new_message), new OnClickListener() {
//                        @Override
...
//                    }
//                });
            share_ok.setVisibility(View.VISIBLE);
            share_ok.setOnClickListener(new OnClickListener() {
                @Override
            ...
            {
                share_ok.setVisibility(View.INVISIBLE);
            }
