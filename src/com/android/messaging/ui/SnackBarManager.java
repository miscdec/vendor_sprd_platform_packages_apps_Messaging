...
public class SnackBarManager {
    ...
    public static volatile SnackBarManager sInstance;
    ...
    public void show(final SnackBar snackBar) {
        ...
        LogUtil.d(LogUtil.BUGLE_TAG, "showing snack bar.");
        placeSnackBarOffScreen(snackBar);
        animateSnackBarOnScreen(snackBar).withEndAction(new Runnable() {
            @Override
            public void run() {
                if(mCurrentSnackBar != null && !mIsCurrentlyDismissing){//for bug763956 begin
