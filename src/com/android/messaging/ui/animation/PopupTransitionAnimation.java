...
public class PopupTransitionAnimation extends Animation {
    ...
    private void initPopupWindow() {
        ...
        Log.d("PopupTransitionAnimation",
                "PopupTransitionAnimation top:" + mViewToAnimate.getTop()
                        + " view.buttom:" + mViewToAnimate.getBottom()
                        + " viewWidth:" + mViewToAnimate.getWidth()
                        + " viewHeight:" + mViewToAnimate.getHeight()
                        + " mPopupWindow.setHeight:"
