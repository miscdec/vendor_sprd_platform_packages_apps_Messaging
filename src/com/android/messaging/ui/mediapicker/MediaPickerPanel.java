...
public class MediaPickerPanel extends ViewGroup {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        try {
            ...
            Log.d("MediaPickerPanel", " onMeasure ", new Throwable());
        }
        //bug840729 end
    ...
    private int getDesiredHeight() {
        if (mFullScreen) {
            ...
            int fullHeight = Utils.getRealWindowHeight(getContext());
            //bug 950173 end
    ...
    private boolean forbidBindingData;//by 1186186
    ...
    private void setDesiredHeight(int height, final boolean animate) {
        ...
        /*bug 1186186, begin*/
        forbidBindingData = !isFullScreen() || animate;
        if (animationEventImpl != null && startHeight > 0 && forbidBindingData) {
            //add for 1354151 1361480
            if (animate) { //when  animate == false, cannot set onGalleryMediaEvent fasle
                animationEventImpl.onGalleryMediaEvent(false);
            }
        }
        /*bug 1186186, end*/
        clearAnimation();
        if (animate) {
            ...
            final Animation animation = new Animation() {
                ...
                protected void applyTransformation(final float interpolatedTime,
                    ...
                    requestLayout();
                    if (animationEventImpl != null && hasEnded() && startHeight > 0) {//by 1186186
                        animationEventImpl.onGalleryMediaEvent(true);
                    }
                }
            ...
            if (mAnimationListener != null) {
                mAnimationListener.onAnimationEnd((Animation) null);
            }
    ...
    interface IAnimationEvent {
        /**
         * @param allowBinding GalleryGridAdapter use this flag to determine binding data or not.
         */
        void onGalleryMediaEvent(boolean allowBinding);
    }

    private IAnimationEvent animationEventImpl;

    /**
     * @param animationEventListener linstening when animation start or ACTION-MOVE
     */
    public void setAnimationEventListener(IAnimationEvent animationEventListener) {
        this.animationEventImpl = animationEventListener;
    }
    /*bug 1186186, end*/
}
