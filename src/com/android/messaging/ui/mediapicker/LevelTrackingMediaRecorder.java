...
public class LevelTrackingMediaRecorder {
    ...
    private static final int MEDIA_RECORDER_OUTPUT_FORMAT = MediaRecorder.OutputFormat.AMR_NB;
            ...
            if (mRecorder == null) {
                ...
                try {
                    ...
                    LogUtil.e(LogUtil.BUGLE_TAG, "Something went wrong when starting " +
                            "media recorder. " + e);
                    //modify for bug 623658
                    UiUtils.showToastAtBottom(R.string.unexpected_recording_error);
                    stopRecording();
                }
            } else {
