    ...
    public void onActivityResult(final int requestCode, final int resultCode,
        ...
        if (requestCode == UIIntents.REQUEST_PICK_AUDIO_PICKER
            ...
            if (data != null) {
                ...
                //modify for bug 606222 begin
                //modify for bug 627476 begin
                Log.d(TAG, "the Uri is:"+(uri!=null?uri.toString():""));
                if (uri == null || "settings".equals(uri.getAuthority().toString())){
                    UiUtils.showToastAtBottom(R.string.attachment_load_failed_dialog_message);
                    return ;
                }
                //modify for bug 627476 end
                if (uri != null) {
                    prepareAudioAttachForAttachment(uri);
                }
                //modify for bug 606222 end
                // break;
            }
        }
