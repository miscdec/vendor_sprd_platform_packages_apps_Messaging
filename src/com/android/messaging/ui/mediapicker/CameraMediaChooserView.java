...
public class CameraMediaChooserView extends FrameLayout implements PersistentInstanceState {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(KEY_CAMERA_INDEX, MediaCameraManager.get().getCameraIndex());
        return bundle;
    }
    ...
    protected void onRestoreInstanceState(final Parcelable state) {
        ...
        MediaCameraManager.get().selectCameraByIndex(bundle.getInt(KEY_CAMERA_INDEX));
    }
    ...
    public void resetState() {
        MediaCameraManager.get().selectCamera(Camera.CameraInfo.CAMERA_FACING_BACK);
    }
