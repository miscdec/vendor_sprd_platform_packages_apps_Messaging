...
//        mTabButton.setImageResource(getIconResource());
        // Default image is a dark image, change it to a light image when this button is selected.
        mTabButton.setImageResource(getIconResource()[1]);
        /* Modify by SPRD for Bug:523092  2016.01.12 End */

        mTabButton.setContentDescription(
                inflater.getContext().getResources().getString(getIconDescriptionResource()));
        //setSelected(mSelected); //bug495177
...
//    abstract int getIconResource();
    ...
    void updateActionBar(final ActionBar actionBar) {
        ...
        if (actionBarTitleResId == 0) {
            ...
            actionBar.setShowHideAnimationEnabled(false); /*addedd for Bug 815733 */
            actionBar.show();
