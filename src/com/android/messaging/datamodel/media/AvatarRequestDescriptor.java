...
public class AvatarRequestDescriptor extends UriImageRequestDescriptor {
    ...
    private static final String SIM1= "1";
    private static final String SIM2= "2";
    ...
    public MediaRequest<ImageResource> buildSyncMediaRequest(final Context context) {
        ...
        } else if (AvatarUriUtil.TYPE_SIM_SELECTOR_URI_SIM1.equals(avatarType)) {
            return new SimLableSelectorAvatarRequest(context, this, SIM1);
        } else if (AvatarUriUtil.TYPE_SIM_SELECTOR_URI_SIM2.equals(avatarType)) {
            return new SimLableSelectorAvatarRequest(context, this, SIM2);
        } else {
