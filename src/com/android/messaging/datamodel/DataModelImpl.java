...
public class DataModelImpl extends DataModel {
    ...
    private final ConnectivityUtil mServicePortConnectivityUtil;
    ...
    public DataModelImpl(final Context context) {
        ...
        if(MmsConfig.getCmccSdkEnabled()||MmsConfig.getCuccSdkEnabled()||MmsConfig.isCtccOp()){
            mServicePortConnectivityUtil  = new ConnectivityUtil(context);
        }else{
            mServicePortConnectivityUtil = null;
        }
       LogUtil.w(LogUtil.BUGLE_TAG, "mServicePortConnectivityUtil"+mServicePortConnectivityUtil);
    ...
    @Override
    public ConnectivityUtil getServicePortConnectivityUtil() {
        return mServicePortConnectivityUtil;
    }
