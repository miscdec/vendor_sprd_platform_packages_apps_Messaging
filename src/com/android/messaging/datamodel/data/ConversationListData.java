...
public class ConversationListData extends BindableData
    ...
    public interface ConversationListDataListener {
        ...
        public void onShareIntentConversationListCursorUpdated(ConversationListData data, Cursor cursor);/*add by sprd for Bug 763200*/
    }
    ...
    private static final int SHARE_INTENT_CONVERSATION_LIST_LOADER = 3;/*add by sprd for Bug 763200*/
            ...
            switch (id) {
                ...
                case CONVERSATION_LIST_LOADER:
                    loader = new BoundCursorLoader(bindingId, mContext,
                            ...
                            SORT_ORDER);
                    break;
                case SHARE_INTENT_CONVERSATION_LIST_LOADER:/*add by sprd for Bug 763200 begin*/
                    loader = new BoundCursorLoader(bindingId, mContext,
                            MessagingContentProvider.CONVERSATIONS_URI,
                            ConversationListItemData.PROJECTION,
                            ConversationColumns.SHOW_DRAFT + "=0", null, SORT_ORDER);
                    break;/*add by sprd for Bug 763200 end*/
                default:
        ...
        if (isBound(loader.getBindingId())) {
            switch (loader.getId()) {
                ...
                case CONVERSATION_LIST_LOADER:
                    ...
                    break;
                case SHARE_INTENT_CONVERSATION_LIST_LOADER:/*add by sprd for Bug 763200 begin*/
                    mListener.onShareIntentConversationListCursorUpdated(this, data);
                    break;/*add by sprd for Bug 763200 end*/
                default:
                    Assert.fail("Unknown loader id");
                    break;
        ...
        if (isBound(loader.getBindingId())) {
            switch (loader.getId()) {
                ...
                case CONVERSATION_LIST_LOADER:
                    ...
                    break;
                case SHARE_INTENT_CONVERSATION_LIST_LOADER:/*add by sprd for Bug 763200 begin*/
                    mListener.onShareIntentConversationListCursorUpdated(this, null);
                    break;/*add by sprd for Bug 763200 end*/
                default:
                    Assert.fail("Unknown loader id");
                    break;
    ...
    public void init(final LoaderManager loaderManager,
        ...
        mLoaderManager.initLoader(SHARE_INTENT_CONVERSATION_LIST_LOADER, mArgs, this);/*add by sprd for Bug 763200 */
    }
    ...
    protected void unregisterListeners() {
        ...
        if (mLoaderManager != null) {
            ...
            mLoaderManager.destroyLoader(SHARE_INTENT_CONVERSATION_LIST_LOADER);/*add by sprd for Bug 763200 */
            mLoaderManager = null;
        }
    }
