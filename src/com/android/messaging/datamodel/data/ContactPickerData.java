...
public class ContactPickerData extends BindableData implements
    ...
    public void init(final LoaderManager loaderManager,
        ...
        //mLoaderManager.initLoader(PARTICIPANT_LOADER, args, this); //Bug 888919
    }
    ...
    protected void unregisterListeners() {
        ...
        if (mLoaderManager != null) {
            ...
            //mLoaderManager.destroyLoader(PARTICIPANT_LOADER); //Bug 888919
            mLoaderManager = null;
        }
        mFrequentContactsCursorBuilder.resetBuilder();
        mListener = null; /*Bug 796017*/
    }
