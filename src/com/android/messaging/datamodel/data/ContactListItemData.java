...
public class ContactListItemData {
    ...
    private String mDisplayAccoutName;
    private String mMimetype;
    public String getDisplayAccoutName() {
        return mDisplayAccoutName;
    }
    ...
    public void bind(final Cursor cursor, final String alphabetHeader) {
        if(cursor.isBeforeFirst()){
            Log.d("ContactListItemData", "======bind====1====");
            if(!cursor.moveToFirst()){
                Log.d("ContactListItemData", "======bind===2=====");
                return;
            }
        }
        ...
        /* Add by SPRD for bug 550235 Start */
        mDisplayAccoutName = cursor.getString(ContactUtil.INDEX_DISPLAY_ACCOUNT_NAME);
        /* Add by SPRD for bug 550235 End */
        mMimetype = cursor.getString(ContactUtil.INDEX_MIMETYPE);
        mStyledName = null;
    ...
    public CharSequence getDestination() {
        final CharSequence destination = mStyledDestination != null ?
                mStyledDestination : mRecipientEntry.getDestination();
    ...
    public void bind(final Cursor cursor, final String alphabetHeader,boolean isProfileSupported) {
        if(cursor.isBeforeFirst()){
            Log.d("ContactListItemData", "======bind====1====");
            if(!cursor.moveToFirst()){
                Log.d("ContactListItemData", "======bind===2=====");
	 ...
	 mMimetype = cursor.getString(ContactUtil.INDEX_MIMETYPE);
        ...
        mIsWorkContact = ContactUtil.isSprdEnterpriseContactId(contactId,isProfileSupported);
    }
}
