...
//    final static int MODE = DATABASE_MODE_QUERIES + DATABASE_MODE_2LINES;
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Log.e("SuggestProvider", "enter SuggestProvider query()");
        ...
        Uri u = Uri.parse(String.format(
                ...
                Uri.encode(selectionArgs[0])));
        System.out.println("after Uri.encode, the uri = [" + u.toString()+"]");
...
/*
        Cursor c = getContext().getContentResolver().query(
                ...
                null);
*/
        Cursor c = BugleDatabaseOperations.QureyMessagingSuggest(selectionArgs[0]);//Bug 880287
