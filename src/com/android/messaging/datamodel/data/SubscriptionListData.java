...
public class SubscriptionListData {
    ...
    public int getSimColor(final int simSlotId) {
        if (mDefaultEntry != null && mDefaultEntry.simSlotId == simSlotId) {
            return mDefaultEntry.displayColor;
        }
        for (final SubscriptionListEntry entry : mEntriesExcludingDefault) {
            if (entry.simSlotId == simSlotId) {
