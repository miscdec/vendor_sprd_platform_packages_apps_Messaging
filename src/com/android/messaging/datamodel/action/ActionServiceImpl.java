...
public class ActionServiceImpl extends JobIntentService {
    ...
    protected void onHandleWork(final Intent intent) {
        ...
        // sprad: fixe for bug 514001 start
        if(!OsUtil.hasSmsPermission()){
            return;
        }
        // sprad: fixe for bug 514001 end
        Action action;
        ...
        switch(opcode) {
            case OP_START_ACTION: {
                ...
                LogUtil.d(TAG,"acton:"+action.getClass().getName());
    ...
    private static final long EXECUTION_TIME_WARN_LIMIT_MS = 800; // 1 second
    /**
