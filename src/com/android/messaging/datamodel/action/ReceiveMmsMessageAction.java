...
public class ReceiveMmsMessageAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        if (mms != null) {
            ...
            mms.mRead = false;//messageInFocusedConversation;
            ...
            try {
                ...
                /*Modify By SPRD for bug:584074 Start*/
                if(MmsConfig.get(subId).getUsingSimInSettingsEnabled()) {
                    BugleDatabaseOperations.updateConversationMetadataInTransaction(db,
                            ...
                            blocked, false /* shouldAutoSwitchSelfId */);
                }
                if (!autoDownload) {
                    if(!MmsConfig.get(subId).getUsingSimInSettingsEnabled()) {
                        BugleDatabaseOperations.updateConversationMetadataInTransaction(db,
                    ...
                    /*Modify By SPRD for bug:584074 End*/
            ...
            if (!autoDownload) {
                ...
                BugleNotifications.update(false/*silent*/, conversationId,
                        ...
                        BugleNotifications.UPDATE_ALL, subId);
