...
public class ProcessDeliveryReportAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        /* Modify by SPRD for bug 531941 Start */
        if (smsMessageUri != null && isSmsDeliveryReport(smsMessageUri)) {
        ...
        try {
            ...
            if (messageData !=  null) {
                ...
                LogUtil.d(TAG, "ProcessDeliveryReportAction: update database");
    ...
    private boolean isSmsDeliveryReport(Uri smsMessageUri) {
        return smsMessageUri.getPath().startsWith(Telephony.Sms.CONTENT_URI.toString());
    }
