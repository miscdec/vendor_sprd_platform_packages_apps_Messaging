...
public class RedownloadMmsAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        if (message != null && message.canRedownloadMessage()) {
            ...
            boolean isExpired = message.getMmsIsExpired();
            LogUtil.d(TAG,"isExpired:"+isExpired);

            if (isExpired) {
                /*Add by SPRD for bug588624  2016.08.16 Start*/
                ...
                /*Add by SPRD for bug588624  2016.08.16 End*/
                return message;
            }
