...
public class DeleteConversationAction extends Action implements Parcelable {
    ...
    public interface DeleteConversationActionListener {
        ...
        abstract void onDeleteConversationActionAction(final boolean success);
    }
    //Bug 983721 end
    ...
    //Bug 983721 begin
    public static void deleteConversation(final String conversationId, final long cutoffTimestamp, DeleteConversationActionListener listener) {
        mListener = listener;
        final DeleteConversationAction action = new DeleteConversationAction(conversationId,
                cutoffTimestamp);
        action.start();
    }
    private static DeleteConversationActionListener mListener = null;
    //Bug 983721 end
    ...
    //Bug 983721 begin
    public static void deleteConversation(String[] conversationIds, final long cutoffTimestamp, long smax, long mmax, DeleteConversationActionListener listener) {
    ...
    protected Bundle doMultiBackgroundWork() throws DataModelException {
        ...
        if (BugleDatabaseOperations.deleteMultiConversation(db, conversationIds,  cutoffTimestamp, smax, mmax)) {
            ...
            LogUtil.e(TAG, "delete SUCCEEDED");
        return null;
    }
    /**
    ...
    protected Object processBackgroundResponse(final Bundle response) {
        LogUtil.w(TAG, "DeleteConversationAction sucessfully...");
        if (null != mListener) {
            mListener.onDeleteConversationActionAction(true);
            SyncManager.sync();
        }
        return null;
    }
    ...
    protected Object processBackgroundFailure() {
        LogUtil.w(TAG, "DeleteConversationAction failed...");
        if (null != mListener) {
            mListener.onDeleteConversationActionAction(false);
            SyncManager.sync();
        }
        return null;
    }
