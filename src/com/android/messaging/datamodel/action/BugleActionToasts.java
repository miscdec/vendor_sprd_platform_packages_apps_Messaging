...
public class BugleActionToasts {
    ...
    static void onSendMessageOrManualDownloadActionCompleted(
        ...
        if (!success && status == MmsUtils.MMS_REQUEST_MANUAL_RETRY) {
            ...
            if(!phoneUtils.hasSim()) {
                showToast(R.string.err_sent_no_sim);
            }
            if (phoneUtils.isAirplaneModeOn()) {
                ...
                if (isSend) {
                    //Modify for 1354167 1391910 In future we can accord fdn to do it
    ...
    private static class UpdateDestinationBlockedActionToast
        ...
        public void onUpdateDestinationBlockedAction(
                ...
                if(success){
                    if(block){
                        UiUtils.showToastAtBottom(R.string.update_destination_blocked);
                    }else{
                        UiUtils.showToastAtBottom(R.string.update_destination_unblocked);
                    }
                 }
              }
