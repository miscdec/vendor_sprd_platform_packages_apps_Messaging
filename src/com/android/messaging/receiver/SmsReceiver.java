...
public final class SmsReceiver extends BroadcastReceiver {
    ...
    public static void deliverSmsMessages(final Context context, final int subId,
        ...
        //for bug694631 begin
        if (MmsConfig.get(((Object) subId != null) ? subId : ParticipantData.DEFAULT_SELF_SUB_ID).getIsSupportReplceSms()) {
            android.telephony.SmsMessage sms = messages[0];
            messageValues.put(MessageData.PROTOCOL_REPLACE, sms.isReplace() ? 1 : 0);
        }//for bug694631 end
...
//                PendingIntentConstants.SMS_SECONDARY_USER_NOTIFICATION_ID, notification);
    ...
    public static android.telephony.SmsMessage[] getMessagesFromIntent(Intent intent) {
        ...
        Log.d("SmsReceiver", "======wap push===1==getMessagesFromIntent=====type:  " + intent.getType() + "  action: " + intent.getAction());
