...
public class ImeUtil {
    ...
    public boolean hideImeKeyboard(@NonNull final Context context, @NonNull final View v) {
        ...
        if (inputMethodManager != null) {
            return inputMethodManager.hideSoftInputFromWindow(v.getWindowToken(), 0 /* flags */);
        }
        return false;
    }

    public boolean showImeKeyboard(@NonNull final Context context, @NonNull final View v) {
        Assert.notNull(context);
        Assert.notNull(v);
        ...
        if (inputMethodManager != null) {
            v.requestFocus();
            return inputMethodManager.showSoftInput(v, 0 /* flags */);
        }
        return false;
    }
