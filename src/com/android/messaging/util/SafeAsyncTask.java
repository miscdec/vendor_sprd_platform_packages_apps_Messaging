...
public abstract class SafeAsyncTask<Params, Progress, Result>
    ...
    public final SafeAsyncTask<Params, Progress, Result> executeOnThreadPool(
        ...
        executeOnExecutor(MESSAGING_THREAD_POOL_EXECUTOR, params); //bug893795: AsyncTask.THREAD_POOL_EXECUTOR -> MESSAGING_THREAD_POOL_EXECUTOR
        return this;
    }
    ...
    public static void executeOnThreadPool(final Runnable runnable, final boolean withWakeLock) {
        if (withWakeLock) {
            ...
            MESSAGING_THREAD_POOL_EXECUTOR.execute(new Runnable() { //bug893795: THREAD_POOL_EXECUTOR -> MESSAGING_THREAD_POOL_EXECUTOR
                @Override
                public void run() {
                    try {
                        runnable.run();
            ...
            MESSAGING_THREAD_POOL_EXECUTOR.execute(runnable); //bug893795: THREAD_POOL_EXECUTOR -> MESSAGING_THREAD_POOL_EXECUTOR
        }
    }
    ...
    public static final Executor MESSAGING_THREAD_POOL_EXECUTOR
