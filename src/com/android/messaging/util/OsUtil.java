...
public class OsUtil {
    ...
    static {
        ...
        sIsAtLeastO = v >= 26;      // 26 is AndroidO sdk version
        sIsAtLeastP = v >=28;
        sIsAtLeastQ = v >=29;
    }
     ...
     * returns true, it cannot return false in the same process as the OS kills the process when
     * any permission is revoked.
     * @param permission A permission from {@link android.Manifest.permission} , context
     */
    ...
    // spread: fixed for bug 519506 end
    ...
    private static String[] sRequiredPermissions = new String[] {
        ...
        // spread: add permission for wap push
        ...
        //Bug950322 end
        // spread: add permission for mms attachment
        //delete for bug811868
    ...
    //spread: fixed for bug 516090 start
    public static void getStoragePreminssion(Activity activity) {
         activity.requestPermissions(
             new String[] { Manifest.permission.READ_EXTERNAL_STORAGE ,Manifest.permission.WRITE_EXTERNAL_STORAGE},0);
    }
    //spread: fixed for bug 516090 end

    //com.android.email.permission.READ_ATTACHMENT
    public static void getEmailPreminssion(Activity activity) {
         if (hasEmailPermission()){
             return ;
         }
         activity.requestPermissions(
             new String[] {"com.android.email.permission.READ_ATTACHMENT", "com.android.email.permission.ACCESS_PROVIDER"},0);
    }

    public static boolean hasEmailPermission() {
        return OsUtil.hasPermission("com.android.email.permission.READ_ATTACHMENT") && OsUtil.hasPermission("com.android.email.permission.ACCESS_PROVIDER");
    }
