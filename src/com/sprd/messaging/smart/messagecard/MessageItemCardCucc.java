...
public class MessageItemCardCucc extends LinearLayout {

    private Context mContext;
    private static final String TAG = "MessageItemCard";
    ...
    public MessageItemCardCucc(Context context) {
        this(context, null);
    }

    public MessageItemCardCucc(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MessageItemCardCucc(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addSmsBody(CardInfo cardInfo) {
        ...
        MessageItemCardBody bodyView = new MessageItemCardBody();
        mUnioncastSmsBody.addView(bodyView.buildBodyView(mContext, cardInfo), new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    }
    ...
    private final Handler mMenuHandler = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            try {
                switch (msg.what) {
                    case SHOW_POPUPWINDOW:
                        String[] appStrings = (String[]) msg.obj;
                ...
                Log.d(TAG, " handle close loading dialog message ", ex.fillInStackTrace());
            }
        }
    };
            ...
            try {
                SmartSmsEngine.getInstance().processMenuOperation((Activity) getContext(), menu.getOperation(), menu.getType(), new ProcessMenuOperationListener() {
                    ...
                    public void showPopupWindow(String strPackageName, String strPackageActName, String appName) {
                        Message message = mMenuHandler.obtainMessage(SHOW_POPUPWINDOW,
                                new String[]{strPackageName, strPackageActName, appName});
    ...
    public interface OnDetailClickButtonLitener {
         ...
         * @param mAdress
         */
        void detailClickButton(String mAdress, String mBody);
    }
}
