...
public class SmscListActivity extends AppCompatActivity {
    ...
    private void showDialog(final TextView tv, final int index) {
      ...
      //  editSmsc.setEnabled(MmsConfig.get(mSubId).getSmscEditable());
        editSmsc.setEnabled(getContext().getResources().getBoolean(R.bool.config_smsc_editable));//(MmsConfig.get(mSubId).getSmscEditable());
