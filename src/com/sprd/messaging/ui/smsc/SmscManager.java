...
public class SmscManager extends ArrayList<String> {
    ...
    public static String getSmscString(Context context, int subId) {
        String smscStr = "";
        smscStr = SystemAdapter.getInstance().getSmscForSubscriber(subId) /*getTelephonyManagerEx().getSmscForSubscriber(subId)*/;
    ...
    public static boolean setSmscString(Context context, String smscStr, int subId) {
        ...
        setResult = SystemAdapter.getInstance().setSmscForSubscriber(subId, smscStr) /*getTelephonyManagerEx().setSmscForSubscriber(smscStr, subId)*/;
...
//    public static TelephonyManagerEx getTelephonyManagerEx() {
//        //return (TelephonyManager) getContext().getSystemService(Context.TELEPHONY_SERVICE);
//        return TelephonyManagerEx.from(getContext());
//    }
}
