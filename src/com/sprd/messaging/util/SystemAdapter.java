...
public class SystemAdapter {
    ...
    public static final Pattern SPRD_DATE = Pattern.compile(
            "[1-2][0-9]{3,3}\\u5e74[0-1][0-9]\\u6708[0-3][0-9]\\u65e5");

    private SystemAdapter() {
        Log.d(TAG, "Messging SystemAdapter  Init Instance");
    }
    ...
    public List<SubscriptionInfo> getActiveSubInfoList() {
        List<SubscriptionInfo> defaultlist = new ArrayList<SubscriptionInfo>();
        SubscriptionManager subManager = SubscriptionManager.from(Factory.get().getApplicationContext());
        List<SubscriptionInfo> list = null;
        try {
            list = subManager.getActiveSubscriptionInfoList();
    ...
    public void setProperty(String key, String value) {
        Settings.Global.putString(Factory.get().getApplicationContext().getContentResolver(),key, value);
    }

    public String getProperty(String key) {
        return Settings.Global.getString(Factory.get().getApplicationContext().getContentResolver(),key);
    }
