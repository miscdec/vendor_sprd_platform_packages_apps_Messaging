...
public class PhaserProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        Log.d("PhaserProvider", mPharserDB.getPath() + "  ;  sLocale:" + sLocale);
        return (mPharserDB != null);
    }

    @Override
    public int delete(Uri uri, String where, String[] selectionArgs) {
        int count = getSqliteDatabase().delete(DatabaseDefine.TABLE_NAME, where, selectionArgs);
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        int count = getSqliteDatabase().update(DatabaseDefine.TABLE_NAME, values, where, whereArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return count;
    }
    ...
    private Handler handler = new Handler();//for bug708941
    ...
    public static final String AUTHORITY = "com.android.messaging.commonphrase";//for bug708941
    ...
    public void onLocaleChanged() {
        ...
        if (mPharserDB != null) {
            handler.post(updateRunnable);//for bug782351
            Log.w(TAG, "post---");
        }
    }
    //add for bug708941 end
